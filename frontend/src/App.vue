...
export default {
        ...
        const dummyData = `[
    {
        "day": "04/06/23",
        "metrics": {
            "banho": { "quantity": 10, "liters": 50 },
            "torneira": { "quantity": 30, "liters":70 },
    ...
    },
    {
        "day": "03/06/23",
        "metrics": {
            "banho": { "quantity": 100, "liters": 300 },
            "torneira": { "quantity": 10, "liters": 40 },
            "descarga": { "quantity": 20, "liters": 30 }
        }
    },
        {
        "day": "02/06/23",
        "metrics": {
            "banho": { "quantity": 50, "liters": 150 },
            "torneira": { "quantity": 10, "liters": 40 },
            "descarga": { "quantity": 20, "liters": 30 }
        }
    }
